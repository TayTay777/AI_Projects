...
public class TaylorPRoberts extends Bot {
    Random r = new Random();
    ...
    public String getPlayerActions(String d1, String d2, String card1, String card2, String board)
        ...
        for (String cardAction : card.split(":")) // just go ahead and do them in this order
        {
            if (cardAction.startsWith("move")) {
                ...
                int playerAskedIndex = r.nextInt(otherPlayerNames.length);
    ...
    // @@@ Nancy=[red,green]
    // @@@
    // @@@ you can use the counts to remove both red and green from Fred's KB, as
    // there
    ...
    public TaylorPRoberts(String playerName, String guestName, int numStartingGems, String gemLocations,
